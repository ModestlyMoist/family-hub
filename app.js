...
let data=JSON.parse(localStorage.getItem('familyHubData')||'null')||SAMPLE; let view='home'; let calendarMode='month'; let taskFilter='All';let taskViewMode='tasks'; let calCursor=new Date(); let habitCursor=weekStart(); let habitMode='week'; let habitSummaryRange='weekly'; calCursor.setDate(1); let activePin=sessionStorage.getItem('familyHubPin')||localStorage.getItem('familyHubPin')||'';
