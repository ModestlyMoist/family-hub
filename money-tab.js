...
(function(){
  function addMoney(){
    ...
    b.addEventListener('click',function(e){e.preventDefault();if(typeof window.openBudget2==='function'){window.openBudget2();setTimeout(function(){window.dispatchEvent(new Event('budget2:render'))},20)}else{alert('Budget is still loading. Please refresh once.')}});
  }
